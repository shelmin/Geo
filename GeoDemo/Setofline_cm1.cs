...
namespace GeoDemo
{
    public delegate void paint0();
    public partial class Setofline_cm1 : Form
    {
        C_M1 form1 = new C_M1();
        public event paint0 paint_refresh;
        public Setofline_cm1(C_M1 cm1form)
        {
            form1 = cm1form;
            InitializeComponent();
            #region 记忆功能
        ...
        {
           // SysData.line_color2 = this.colorPickerButton1.SelectedColor;

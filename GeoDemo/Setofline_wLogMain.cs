...
namespace GeoDemo
{
    public delegate void paint7();
    public partial class Setofline_wLogMain : Form
    {
        WellLog_Main form1 = new WellLog_Main();
        public event paint7 paint_refresh;
        public Setofline_wLogMain(WellLog_Main ztform)
        {
            form1 = ztform;
            InitializeComponent();
            #region 记忆功能
        ...
        private void buttonX5_Click(object sender, EventArgs e)
        {
            ...
            //SysData.line1 = 1;
            //SysData.line2 = 3;
            //SysData.line_color = Color.Gray;
            //SysData.line_color2 = Color.Black;
        ...
        {
            SysData.comboxselected = comboBox3.SelectedIndex;
        }

        private void checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            SysData.IsDrawLine = checkBox2.Checked;
        }
        ...
        {
            SysData.IsDrawWords = checkBox3.Checked;
        }

        private void buttonX8_Click(object sender, EventArgs e)
        {
            checkBox3.Checked = SysData.IsDrawWords = false;
            checkBox2.Checked = SysData.IsDrawLine = false;

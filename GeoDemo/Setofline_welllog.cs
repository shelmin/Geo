...
namespace GeoDemo
{
    public delegate void paint3();
    public partial class Setofline_welllog : Form
    {
        WellLog form1 = new WellLog();
        public event paint3 paint_refresh;
        public Setofline_welllog(WellLog cjform)
        {
            form1 = cjform;
            InitializeComponent();
            #region 记忆功能

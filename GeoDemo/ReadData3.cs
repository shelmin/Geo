...
namespace GeoDemo
{
    public partial class ReadData3 : Form
    {
        public ReadData3()
        {
            InitializeComponent();
        ...
        private void button_Bind_Click(object sender, EventArgs e)
        {
            ...
            //绘制表格
            if (this.comboBox_Value1.SelectedIndex == -1 || this.comboBox_Value2.SelectedIndex == -1 || this.comboBox_Value3.SelectedIndex == -1 || this.comboBox_Value4.SelectedIndex == -1)
            {
            ...
            if (strX.Equals(strY1) || strX.Equals(strY2) || strX.Equals(strY3) || strY1.Equals(strY2) || strY1.Equals(strY3) || strY2.Equals(strY3))
            {
            ...
            for (int i = 0; i < newDataSet.Tables[0].Rows.Count; i++)
            {
                for (int j = 1; j < newDataSet.Tables[0].Columns.Count; j++)
                {
            ...
            try
            {
                ...
                DataTable dat = dataTables.DefaultView.ToTable(false, new string[] { strX, strY1 ,strY2,strY3});
        ...
        private void 读取数据3_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                if (MyObject.Dataset != null)//已经绑定了数据
                {
                    ...
                    readdatafromdatatable.readDataService(ref x, ref y, ref x, ref yy, ref x, ref yyy);
        ...
        private void 粘贴ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            this.comboBox_Value4.Items.Clear();
            sheetNameList.Add("sheet1");
            DataSet ds = new DataSet();
            try
            {
        ...
        private void 读取数据3_Load(object sender, EventArgs e)
        {

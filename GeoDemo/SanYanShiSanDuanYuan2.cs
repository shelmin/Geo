...
namespace GeoDemo
{
    public partial class SanYanShiSanDuanYuan2 : Form
    {
        struct area
        {
            public int i;//模块编号
        ...
        private void Form5_Paint(object sender, PaintEventArgs e)
        {
          ...
          //  areas[0].pc = Point_Center(areas[0].p);
            ...
            g.DrawLine(mypen1, 311, 119, 280, 119);
            g.DrawString("石英砂岩", myfont, new SolidBrush(Color.Black), 230, 113);
            g.DrawLine(mypen1, 288, 160, 241, 160);
            g.DrawString("长石质石英砂岩", myfont, new SolidBrush(Color.Black), 150, 155);
            g.DrawLine(mypen1, 330, 160, 374, 160);
            g.DrawString("岩屑质石英砂岩", myfont, new SolidBrush(Color.Black), 378, 155);

            g.DrawLine(mypen1, 310, 215, 400, 215);
            g.DrawString("长石岩屑石英砂岩", myfont, new SolidBrush(Color.Black), 405, 210);
            ...
            for (int i = 0; i < str.Length; i++)
            {
                px = px - 10;
                py = py + 30;
                g.DrawString(str[i], myfont, new SolidBrush(Color.Black), 248 + px, 240 + py);
            }
            ...
            for (int i = 0; i < str1.Length; i++)
            {
                px = px - 5;
                py = py + 30;
                g.DrawString(str1[i], myfont, new SolidBrush(Color.Black), 285 + px, 225 + py);
            }

            string[] str2 = new string[7] { "长", "石", "质", "岩", "屑", "砂", "岩" };
            px = 0; py = 0;
            for (int i = 0; i < str2.Length; i++)
            {
                px = px + 5;
                py = py + 30;
                g.DrawString(str2[i], myfont, new SolidBrush(Color.Black), 325 + px, 225 + py);
            }
            ...
            for (int i = 0; i < str3.Length; i++)
            {
                px = px + 10;
                py = py + 30;
                g.DrawString(str3[i], myfont, new SolidBrush(Color.Black), 368 + px, 240 + py);
            }
        ...
        private void 复制ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MyObject.MyCurrentFrmName1 = "岩石三端元图图二";

...
namespace GeoDemo
{
    public delegate void paint6();
    public partial class Setofline_oilwater : Form
    {
        OilWater form1 = new OilWater();
        public event paint6 paint_refresh;
        public Setofline_oilwater(OilWater yqform)
        {
            form1 = yqform;
            InitializeComponent();
            #region 记忆功能
